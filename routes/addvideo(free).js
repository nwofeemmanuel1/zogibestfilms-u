...
const Video=require("../model/freevideomodel/freevideo")
const validatevideo=require("../validations/freevideos/validatevideo(free)")
const Router=express.Router()

const token=Math.random(17.1+32*71*3562*27285726272*382+91*57657220*828928373733*5625262*27762762727+2*774.1+111*812+1.1+0001+12*123)
// console.log(token)
...
try{
  ...
  const newvideo=  await new Video({
     freethumbnail:req.body.thumbnail_id,
     preview:req.body.preview_id,
     videoLink:`http://localhost:8080/api/freevideo/${req.files[0].filename}`
})
